...
class PokemonCardFactory {
  ...
  createDetailedCard(pokemon) {
    return this.builder.setPokemon(pokemon).setShowDetail(true).build();
  }

  createMinimalCard(pokemon) {
    return this.builder.setPokemon(pokemon).setShowDetail(false).build();
  }
  ...
  createErrorCard(searchError) {
    ...
    return this.builder.setPokemon(errorPokemon).setShowDetail(false).build();
  }
}
